...
with open(file, encoding='utf8') as f:
    ...
    for line in csvreader:
        ...
        query = """
        INSERT INTO artist_songtitle_and_length_table (sessionId,itemInSession,artist, song,length)
        VALUES (%s, %s, %s, %s, %s)
        """
        try:
...
with open(file, encoding='utf8') as f:
    ...
    for line in csvreader:
        ...
        query = """
        INSERT INTO AllHandsAgainstHisOwn_listeners_table (song, userId, sessionId, itemInSession, firstname, lastname)
        VALUES (%s, %s, %s, %s,%s,%s);
        """
